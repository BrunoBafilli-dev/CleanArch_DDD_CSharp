...
namespace Testes
{
    public class UnitTest1
    {
        ...
        public async Task CreateRequestAsync()
        {
            ...
            {
                new RequestItemEntityDTO() { Name = "Produto B", ItemId = 2, PriceItem = new PriceItem(0.00M), QuantityItem = new QuantityItem(1) },
                new RequestItemEntityDTO() { Name = "Produto C", ItemId = 3, PriceItem = new PriceItem(0.00M), QuantityItem = new QuantityItem(2) },
                new RequestItemEntityDTO() { Name = "Produto A", ItemId = 4, PriceItem = new PriceItem(0.00M), QuantityItem = new QuantityItem(3) }
            };
