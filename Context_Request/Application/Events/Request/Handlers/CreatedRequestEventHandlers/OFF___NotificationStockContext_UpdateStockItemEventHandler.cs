...
namespace Application.Request.Events.Request.Handlers.CreatePruductEvents
{
    ...
    public class OFF___NotificationStockContext_UpdateStockItemEventHandler
    {
        private readonly IMediator _mediator;

        public OFF___NotificationStockContext_UpdateStockItemEventHandler(IMediator mediator)
        {
            _mediator = mediator;
        }
